...
- lv1 là 1 website với 3 tab chính
...
Trong mã nguồn `/web/src/shutdown.php`, nếu người truy cập tới server có IP là 127.0.0.1 thì sẽ có quyền shutdown website.
...
Vậy sẽ ra sao nếu người dùng nhập URL nội bộ server vào feature để chính server(IP:127.0.0.1) tự gửi request tới tính năng shutdown?
#### Steps to reproduce
Nhập URL local: `http://localhost:9001/shutdown.php` vào tab feature
